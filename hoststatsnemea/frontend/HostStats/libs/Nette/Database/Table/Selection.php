...
class TableSelection extends Object implements Iterator, ArrayAccess, Countable
{
	...
	/** @var GroupedTableSelection[] cached array of GroupedSelection prototypes */
	...
	{
		if (is_array($this->primary) && Validators::isList($key)) {
	...
	{
		return new TableSelection(($tmp=$table) ? $tmp : $this->name, $this->connection);
	}
	...
	{
		return new GroupedTableSelection($this, $table, $column);
	}
