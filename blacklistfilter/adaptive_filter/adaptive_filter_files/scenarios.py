...
class Scenario:
    def __init__(self, detection_event):
        ...
        self.grouped_events = []
        self.grouped_events.append(detection_event)
        self.grouped_events_cnt = 1
        self.id = str(uuid4())
...
class DNSDetection(Scenario):
    ...
    def convert_to_evidence_fmt(self):
        ...
        evid_format['grouped_events'] = [x.strRecord() for x in evid_format['grouped_events']]
        return evid_format
