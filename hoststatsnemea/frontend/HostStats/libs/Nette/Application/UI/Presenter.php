...
abstract class Presenter extends Control implements IPresenter
{
	...
	public function __construct(DIContainer $context = NULL)
	{
	...
	{
		if (is_string($action) && Strings::match($action, '#^[a-zA-Z0-9][a-zA-Z0-9_\x7f-\xff]*\z#')) {
			$this->action = $action;
			$this->view = $action;
	 ...
	 * @return void
	 */
	final public function injectPrimary(DIContainer $context)
	{
		$this->context = $context;
	}
